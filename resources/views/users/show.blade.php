          ...
          <section class="content-header">
              <div class="card">
                  <div class="card-header d-flex" style="height: 65px;">
                      <a href="{{ route('users.create') }}" class="btn btn-block btn-info" style="position: absolute;width: 150px; right: 40px;">Thêm người dùng</a>
                  </div>
                  <!-- /.card-header -->
                  <!-- /.card-body -->
                  <div class="card-body">
                      <table class="table table-bordered" style="text-align: center;">
                          ...
                          <tbody>
                              ...
                              <tr>
                                  ...
                                  <td>
                                    <div class="btn-group">
                                        <form action="{{ url('/users', ['id' => $item->id]) }}" method="POST">
                                            @csrf
                                            @method('PUT')
